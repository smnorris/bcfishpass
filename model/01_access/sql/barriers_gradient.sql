...
SELECT
    ...
    case 
      when b.gradient_class = 5  then'GRADIENT_05'
      when b.gradient_class = 10 then'GRADIENT_10'
      when b.gradient_class = 15 then'GRADIENT_15'
      when b.gradient_class = 20 then'GRADIENT_20'
      when b.gradient_class = 25 then'GRADIENT_25'
      when b.gradient_class = 30 then'GRADIENT_30'
    end as barrier_type,
