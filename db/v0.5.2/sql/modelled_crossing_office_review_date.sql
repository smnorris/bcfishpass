...
comment on column bcfishpass.crossings_vw.modelled_crossing_office_review_date IS 'Date of most recent office review (satellite imagery, etc) at site of modelled crossing. NULL if crossing has not been reviewed';
