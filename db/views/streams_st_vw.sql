drop view if exists bcfishpass.streams_st_vw;
create or replace view bcfishpass.streams_st_vw as
  with obs as
(
 select
   segmented_stream_id,
...
select
  ...
  model_spawning_st as spawning,
  model_rearing_st as rearing,
