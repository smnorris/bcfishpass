begin; 
  ...
  select
     ...
     case
       ...
       when b.barriers_ch_dnstr is null and wsg_salmon.watershed_group_code is not null then array[]::text[]
       when b.barriers_ch_dnstr is null and wsg_salmon.watershed_group_code is null then null
     end as barriers_ch_dnstr,
     case
       when b.barriers_cm_dnstr is not null then b.barriers_cm_dnstr
       when b.barriers_cm_dnstr is null and wsg_salmon.watershed_group_code is not null then array[]::text[]
       when b.barriers_cm_dnstr is null and wsg_salmon.watershed_group_code is null then null
     end as barriers_cm_dnstr,
     case
       when b.barriers_co_dnstr is not null then b.barriers_co_dnstr
       when b.barriers_co_dnstr is null and wsg_salmon.watershed_group_code is not null then array[]::text[]
       when b.barriers_co_dnstr is null and wsg_salmon.watershed_group_code is null then null
     end as barriers_co_dnstr,
     case
       when b.barriers_pk_dnstr is not null then b.barriers_pk_dnstr
       when b.barriers_pk_dnstr is null and wsg_salmon.watershed_group_code is not null then array[]::text[]
       when b.barriers_pk_dnstr is null and wsg_salmon.watershed_group_code is null then null
     end as barriers_pk_dnstr,
     case
       when b.barriers_sk_dnstr is not null then b.barriers_sk_dnstr
       when b.barriers_sk_dnstr is null and wsg_salmon.watershed_group_code is not null then array[]::text[]
       when b.barriers_sk_dnstr is null and wsg_salmon.watershed_group_code is null then null
     ...
     case
       ...
       when b.barriers_ch_dnstr is not null and wsg_salmon.watershed_group_code is not null then 0
     end as access_ch,
     case
       when wsg_salmon.watershed_group_code is null then -9
       ...
       when b.barriers_cm_dnstr is not null and wsg_salmon.watershed_group_code is not null then 0
     end as access_cm,
     case
       when wsg_salmon.watershed_group_code is null then -9
       ...
       when b.barriers_co_dnstr is not null and wsg_salmon.watershed_group_code is not null then 0
     end as access_co,
     case
       when wsg_salmon.watershed_group_code is null then -9
       ...
       when b.barriers_pk_dnstr is not null and wsg_salmon.watershed_group_code is not null then 0
     end as access_pk,
     case
       when wsg_salmon.watershed_group_code is null then -9
       ...
       when b.barriers_sk_dnstr is not null and wsg_salmon.watershed_group_code is not null then 0
     end as access_sk,
     case
       when wsg_salmon.watershed_group_code is null then -9
       when (
        (b.barriers_ch_dnstr is null AND wsg_salmon.watershed_group_code is not null) OR
        (b.barriers_cm_dnstr is null AND wsg_salmon.watershed_group_code is not null) OR
        (b.barriers_co_dnstr is null AND wsg_salmon.watershed_group_code is not null) OR
        (b.barriers_pk_dnstr is null AND wsg_salmon.watershed_group_code is not null) OR
        (b.barriers_sk_dnstr is null AND wsg_salmon.watershed_group_code is not null)
       )
       ...
       ) and wsg_salmon.watershed_group_code is not null
       then 0
