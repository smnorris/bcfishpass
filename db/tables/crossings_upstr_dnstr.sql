...
drop table if exists bcfishpass.crossings_dnstr_crossings;
create table bcfishpass.crossings_dnstr_crossings (
	aggregated_crossings_id text primary key, 
	features_dnstr text[]
);

drop table if exists bcfishpass.crossings_dnstr_barriers_anthropogenic;
create table bcfishpass.crossings_dnstr_barriers_anthropogenic (
	aggregated_crossings_id text primary key, 
	features_dnstr text[]
);

drop table if exists bcfishpass.crossings_upstr_barriers_anthropogenic;
create table bcfishpass.crossings_upstr_barriers_anthropogenic (
	aggregated_crossings_id text primary key, 
	features_upstr text[]
	);

drop table if exists bcfishpass.barriers_anthropogenic_dnstr_barriers_anthropogenic;
