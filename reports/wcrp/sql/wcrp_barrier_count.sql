DROP FUNCTION bcfishpass.wcrp_barrier_count(text,text);

CREATE FUNCTION bcfishpass.wcrp_barrier_count(watershed_group TEXT, barrier_type TEXT)
...
COMMENT ON FUNCTION bcfishpass.wcrp_barrier_count IS
