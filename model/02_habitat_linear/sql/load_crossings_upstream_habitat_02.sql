...
SET
  ...
  bt_spawningrearing_belowupstrbarriers_km = bt_spawningrearing_km,
...
(
  select
    ...
    sum(b.bt_spawningrearing_km) as bt_spawningrearing_km,
...
SET
  ...
  bt_spawningrearing_belowupstrbarriers_km = round((a.bt_spawningrearing_km - b.bt_spawningrearing_km)::numeric, 2),
