...
-- these are similar to fptwg per watershed summary but include habitat
...
create table bcfishpass.log_aw_linear_summary (
 ...
 length_naturallyaccessible_obsrvd_bt                   numeric,  -- naturally accessible
...
select distinct on (s.assessment_watershed_id)
  ...
  -- percentages
  round(coalesce((s.length_naturallyaccessible_obsrvd_bt_access_b + s.length_naturallyaccessible_model_bt_access_b) / nullif((s.length_naturallyaccessible_obsrvd_bt + s.length_naturallyaccessible_model_bt), 0), 0) * 100, 2) as pct_potentiallyaccessible_bt_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_ch_access_b + s.length_naturallyaccessible_model_ch_access_b) / nullif((s.length_naturallyaccessible_obsrvd_ch + s.length_naturallyaccessible_model_ch), 0), 0) * 100, 2) as pct_potentiallyaccessible_ch_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_cm_access_b + s.length_naturallyaccessible_model_cm_access_b) / nullif((s.length_naturallyaccessible_obsrvd_cm + s.length_naturallyaccessible_model_cm), 0), 0) * 100, 2) as pct_potentiallyaccessible_cm_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_co_access_b + s.length_naturallyaccessible_model_co_access_b) / nullif((s.length_naturallyaccessible_obsrvd_co + s.length_naturallyaccessible_model_co), 0), 0) * 100, 2) as pct_potentiallyaccessible_co_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_pk_access_b + s.length_naturallyaccessible_model_pk_access_b) / nullif((s.length_naturallyaccessible_obsrvd_pk + s.length_naturallyaccessible_model_pk), 0), 0) * 100, 2) as pct_potentiallyaccessible_pk_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_sk_access_b + s.length_naturallyaccessible_model_sk_access_b) / nullif((s.length_naturallyaccessible_obsrvd_sk + s.length_naturallyaccessible_model_sk), 0), 0) * 100, 2) as pct_potentiallyaccessible_sk_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_salmon_access_b + s.length_naturallyaccessible_model_salmon_access_b) / nullif((s.length_naturallyaccessible_obsrvd_salmon + s.length_naturallyaccessible_model_salmon), 0), 0) * 100, 2) as pct_potentiallyaccessible_salmon_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_st_access_b + s.length_naturallyaccessible_model_st_access_b) / nullif((s.length_naturallyaccessible_obsrvd_st + s.length_naturallyaccessible_model_st), 0), 0) * 100, 2) as pct_potentiallyaccessible_st_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_wct_access_b + s.length_naturallyaccessible_model_wct_access_b) / nullif((s.length_naturallyaccessible_obsrvd_wct + s.length_naturallyaccessible_model_wct), 0), 0) * 100, 2) as pct_potentiallyaccessible_wct_access_b,
...
select
  ...
  a.pct_potentiallyaccessible_ch_access_b - b.pct_potentiallyaccessible_ch_access_b as pct_potentiallyaccessible_ch_access_b,
  a.pct_potentiallyaccessible_cm_access_b - b.pct_potentiallyaccessible_cm_access_b as pct_potentiallyaccessible_cm_access_b,
  a.pct_potentiallyaccessible_co_access_b - b.pct_potentiallyaccessible_co_access_b as pct_potentiallyaccessible_co_access_b,
  a.pct_potentiallyaccessible_pk_access_b - b.pct_potentiallyaccessible_pk_access_b as pct_potentiallyaccessible_pk_access_b,
  a.pct_potentiallyaccessible_sk_access_b - b.pct_potentiallyaccessible_sk_access_b as pct_potentiallyaccessible_sk_access_b,
...
with sums as (
  select
    ...
    sum(s.length_naturallyaccessible_obsrvd_bt) as length_naturallyaccessible_obsrvd_bt,
    sum(s.length_naturallyaccessible_obsrvd_bt_access_a) as length_naturallyaccessible_obsrvd_bt_access_a,
    sum(s.length_naturallyaccessible_obsrvd_bt_access_b) as length_naturallyaccessible_obsrvd_bt_access_b,
    sum(s.length_naturallyaccessible_model_bt) as length_naturallyaccessible_model_bt,
    sum(s.length_naturallyaccessible_model_bt_access_a) as length_naturallyaccessible_model_bt_access_a,
    sum(s.length_naturallyaccessible_model_bt_access_b) as length_naturallyaccessible_model_bt_access_b,
    sum(s.length_naturallyaccessible_obsrvd_ch) as length_naturallyaccessible_obsrvd_ch,
    sum(s.length_naturallyaccessible_obsrvd_ch_access_a) as length_naturallyaccessible_obsrvd_ch_access_a,
    sum(s.length_naturallyaccessible_obsrvd_ch_access_b) as length_naturallyaccessible_obsrvd_ch_access_b,
    sum(s.length_naturallyaccessible_model_ch) as length_naturallyaccessible_model_ch,
    sum(s.length_naturallyaccessible_model_ch_access_a) as length_naturallyaccessible_model_ch_access_a,
    sum(s.length_naturallyaccessible_model_ch_access_b) as length_naturallyaccessible_model_ch_access_b,
    sum(s.length_naturallyaccessible_obsrvd_cm) as length_naturallyaccessible_obsrvd_cm,
    sum(s.length_naturallyaccessible_obsrvd_cm_access_a) as length_naturallyaccessible_obsrvd_cm_access_a,
    sum(s.length_naturallyaccessible_obsrvd_cm_access_b) as length_naturallyaccessible_obsrvd_cm_access_b,
    sum(s.length_naturallyaccessible_model_cm) as length_naturallyaccessible_model_cm,
    sum(s.length_naturallyaccessible_model_cm_access_a) as length_naturallyaccessible_model_cm_access_a,
    sum(s.length_naturallyaccessible_model_cm_access_b) as length_naturallyaccessible_model_cm_access_b,
    sum(s.length_naturallyaccessible_obsrvd_co) as length_naturallyaccessible_obsrvd_co,
    sum(s.length_naturallyaccessible_obsrvd_co_access_a) as length_naturallyaccessible_obsrvd_co_access_a,
    sum(s.length_naturallyaccessible_obsrvd_co_access_b) as length_naturallyaccessible_obsrvd_co_access_b,
    sum(s.length_naturallyaccessible_model_co) as length_naturallyaccessible_model_co,
    sum(s.length_naturallyaccessible_model_co_access_a) as length_naturallyaccessible_model_co_access_a,
    sum(s.length_naturallyaccessible_model_co_access_b) as length_naturallyaccessible_model_co_access_b,
    sum(s.length_naturallyaccessible_obsrvd_pk) as length_naturallyaccessible_obsrvd_pk,
    sum(s.length_naturallyaccessible_obsrvd_pk_access_a) as length_naturallyaccessible_obsrvd_pk_access_a,
    sum(s.length_naturallyaccessible_obsrvd_pk_access_b) as length_naturallyaccessible_obsrvd_pk_access_b,
    sum(s.length_naturallyaccessible_model_pk) as length_naturallyaccessible_model_pk,
    sum(s.length_naturallyaccessible_model_pk_access_a) as length_naturallyaccessible_model_pk_access_a,
    sum(s.length_naturallyaccessible_model_pk_access_b) as length_naturallyaccessible_model_pk_access_b,
    sum(s.length_naturallyaccessible_obsrvd_sk) as length_naturallyaccessible_obsrvd_sk,
    sum(s.length_naturallyaccessible_obsrvd_sk_access_a) as length_naturallyaccessible_obsrvd_sk_access_a,
    sum(s.length_naturallyaccessible_obsrvd_sk_access_b) as length_naturallyaccessible_obsrvd_sk_access_b,
    sum(s.length_naturallyaccessible_model_sk) as length_naturallyaccessible_model_sk,
    sum(s.length_naturallyaccessible_model_sk_access_a) as length_naturallyaccessible_model_sk_access_a,
    sum(s.length_naturallyaccessible_model_sk_access_b) as length_naturallyaccessible_model_sk_access_b,
    sum(s.length_naturallyaccessible_obsrvd_salmon) as length_naturallyaccessible_obsrvd_salmon,
    sum(s.length_naturallyaccessible_obsrvd_salmon_access_a) as length_naturallyaccessible_obsrvd_salmon_access_a,
    sum(s.length_naturallyaccessible_obsrvd_salmon_access_b) as length_naturallyaccessible_obsrvd_salmon_access_b,
    sum(s.length_naturallyaccessible_model_salmon) as length_naturallyaccessible_model_salmon,
    sum(s.length_naturallyaccessible_model_salmon_access_a) as length_naturallyaccessible_model_salmon_access_a,
    sum(s.length_naturallyaccessible_model_salmon_access_b) as length_naturallyaccessible_model_salmon_access_b,
    sum(s.length_naturallyaccessible_obsrvd_st) as length_naturallyaccessible_obsrvd_st,
    sum(s.length_naturallyaccessible_obsrvd_st_access_a) as length_naturallyaccessible_obsrvd_st_access_a,
    sum(s.length_naturallyaccessible_obsrvd_st_access_b) as length_naturallyaccessible_obsrvd_st_access_b,
    sum(s.length_naturallyaccessible_model_st) as length_naturallyaccessible_model_st,
    sum(s.length_naturallyaccessible_model_st_access_a) as length_naturallyaccessible_model_st_access_a,
    sum(s.length_naturallyaccessible_model_st_access_b) as length_naturallyaccessible_model_st_access_b,
    sum(s.length_naturallyaccessible_obsrvd_wct) as length_naturallyaccessible_obsrvd_wct,
    sum(s.length_naturallyaccessible_obsrvd_wct_access_a) as length_naturallyaccessible_obsrvd_wct_access_a,
    sum(s.length_naturallyaccessible_obsrvd_wct_access_b) as length_naturallyaccessible_obsrvd_wct_access_b,
    sum(s.length_naturallyaccessible_model_wct) as length_naturallyaccessible_model_wct,
    sum(s.length_naturallyaccessible_model_wct_access_a) as length_naturallyaccessible_model_wct_access_a,
    sum(s.length_naturallyaccessible_model_wct_access_b) as length_naturallyaccessible_model_wct_access_b,
