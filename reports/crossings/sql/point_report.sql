...
-- bull trout model
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_bt_dnstr = array[]::text[]) / 1000)::numeric), 2), 0) AS bt_network_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_bt_dnstr = array[]::text[] AND (wb.waterbody_type = 'R' OR (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300))))) / 1000)::numeric, 2), 0) AS bt_stream_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (
    WHERE (s.barriers_bt_dnstr = array[]::text[]) AND (s.gradient >= 0 AND s.gradient < .03) AND (wb.waterbody_type != 'R' OR (wb.waterbody_type IS NOT NULL AND s.edge_type NOT IN (1000,1100,2000,2300)))
  )) / 1000)::numeric, 2), 0) AS bt_slopeclass03_waterbodies_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (
    WHERE (s.barriers_bt_dnstr = array[]::text[]) AND (s.gradient >= 0 AND s.gradient < .03) AND (wb.waterbody_type = 'R' OR (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)))
  )) / 1000)::numeric, 2), 0) AS bt_slopeclass03_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_bt_dnstr = array[]::text[] AND (s.gradient >= .03 AND s.gradient < .05)) / 1000))::numeric, 2), 0) as bt_slopeclass05_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_bt_dnstr = array[]::text[] AND (s.gradient >= .05 AND s.gradient < .08)) / 1000))::numeric, 2), 0) as bt_slopeclass08_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_bt_dnstr = array[]::text[] AND (s.gradient >= .08 AND s.gradient < .15)) / 1000))::numeric, 2), 0) as bt_slopeclass15_km,
...
-- salmon model
  ...
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (
    WHERE (s.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[]) AND (s.gradient >= 0 AND s.gradient < .03) AND (wb.waterbody_type != 'R' OR (wb.waterbody_type IS NOT NULL AND s.edge_type NOT IN (1000,1100,2000,2300)))
  )) / 1000)::numeric, 2), 0) AS ch_cm_co_pk_sk_slopeclass03_waterbodies_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (
    WHERE (s.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[]) AND (s.gradient >= 0 AND s.gradient < .03) AND (wb.waterbody_type = 'R' OR (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)))
  ...
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[] AND (s.gradient >= .05 AND s.gradient < .08)) / 1000))::numeric, 2), 0) as ch_cm_co_pk_sk_slopeclass08_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[] AND (s.gradient >= .08 AND s.gradient < .15)) / 1000))::numeric, 2), 0) as ch_cm_co_pk_sk_slopeclass15_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[] AND (s.gradient >= .15 AND s.gradient < .22)) / 1000))::numeric, 2), 0) as ch_cm_co_pk_sk_slopeclass22_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[] AND (s.gradient >= .22 AND s.gradient < .3)) / 1000))::numeric, 2), 0) as ch_cm_co_pk_sk_slopeclass30_km,

-- steelhead
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_st_dnstr = array[]::text[]) / 1000)::numeric), 2), 0) AS st_network_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_st_dnstr = array[]::text[] AND (wb.waterbody_type = 'R' OR (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300))))) / 1000)::numeric, 2), 0) AS st_stream_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (
    WHERE (s.barriers_st_dnstr = array[]::text[]) AND (s.gradient >= 0 AND s.gradient < .03) AND (wb.waterbody_type != 'R' OR (wb.waterbody_type IS NOT NULL AND s.edge_type NOT IN (1000,1100,2000,2300)))
  )) / 1000)::numeric, 2), 0) AS st_slopeclass03_waterbodies_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (
    WHERE (s.barriers_st_dnstr = array[]::text[]) AND (s.gradient >= 0 AND s.gradient < .03) AND (wb.waterbody_type = 'R' OR (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)))
  )) / 1000)::numeric, 2), 0) AS st_slopeclass03_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_st_dnstr = array[]::text[] AND (s.gradient >= .03 AND s.gradient < .05)) / 1000))::numeric, 2), 0) as st_slopeclass05_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_st_dnstr = array[]::text[] AND (s.gradient >= .05 AND s.gradient < .08)) / 1000))::numeric, 2), 0) as st_slopeclass08_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_st_dnstr = array[]::text[] AND (s.gradient >= .08 AND s.gradient < .15)) / 1000))::numeric, 2), 0) as st_slopeclass15_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_st_dnstr = array[]::text[] AND (s.gradient >= .15 AND s.gradient < .22)) / 1000))::numeric, 2), 0) as st_slopeclass22_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_st_dnstr = array[]::text[] AND (s.gradient >= .22 AND s.gradient < .30)) / 1000))::numeric, 2), 0) as st_slopeclass30_km,

-- wct
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_wct_dnstr = array[]::text[]) / 1000)::numeric), 2), 0) AS wct_network_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_wct_dnstr = array[]::text[] AND (wb.waterbody_type = 'R' OR (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300))))) / 1000)::numeric, 2), 0) AS wct_stream_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (
    WHERE (s.barriers_wct_dnstr = array[]::text[]) AND (s.gradient >= 0 AND s.gradient < .03) AND (wb.waterbody_type != 'R' OR (wb.waterbody_type IS NOT NULL AND s.edge_type NOT IN (1000,1100,2000,2300)))
  )) / 1000)::numeric, 2), 0) AS wct_slopeclass03_waterbodies_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (
    WHERE (s.barriers_wct_dnstr = array[]::text[]) AND (s.gradient >= 0 AND s.gradient < .03) AND (wb.waterbody_type = 'R' OR (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)))
  )) / 1000)::numeric, 2), 0) AS wct_slopeclass03_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_wct_dnstr = array[]::text[] AND (s.gradient >= .03 AND s.gradient < .05)) / 1000))::numeric, 2), 0) as wct_slopeclass05_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_wct_dnstr = array[]::text[] AND (s.gradient >= .05 AND s.gradient < .08)) / 1000))::numeric, 2), 0) as wct_slopeclass08_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_wct_dnstr = array[]::text[] AND (s.gradient >= .08 AND s.gradient < .15)) / 1000))::numeric, 2), 0) as wct_slopeclass15_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_wct_dnstr = array[]::text[] AND (s.gradient >= .15 AND s.gradient < .22)) / 1000))::numeric, 2), 0) as wct_slopeclass22_km,
  COALESCE(ROUND(((SUM(ST_Length(s.geom)) FILTER (WHERE s.barriers_wct_dnstr = array[]::text[] AND (s.gradient >= .22 AND s.gradient < .30)) / 1000))::numeric, 2), 0) as wct_slopeclass30_km,
...
SET
  ...
  ch_cm_co_pk_sk_stream_km = r.ch_cm_co_pk_sk_stream_km,
  ch_cm_co_pk_sk_slopeclass03_waterbodies_km = r.ch_cm_co_pk_sk_slopeclass03_waterbodies_km,
  ch_cm_co_pk_sk_slopeclass03_km = r.ch_cm_co_pk_sk_slopeclass03_km,
  ch_cm_co_pk_sk_slopeclass05_km = r.ch_cm_co_pk_sk_slopeclass05_km,
  ch_cm_co_pk_sk_slopeclass08_km = r.ch_cm_co_pk_sk_slopeclass08_km,
  ch_cm_co_pk_sk_slopeclass15_km = r.ch_cm_co_pk_sk_slopeclass15_km,
  ch_cm_co_pk_sk_slopeclass22_km = r.ch_cm_co_pk_sk_slopeclass22_km,
  ch_cm_co_pk_sk_slopeclass30_km = r.ch_cm_co_pk_sk_slopeclass30_km,
...
(SELECT
  ...
  ROUND(((SUM(COALESCE(uwb.area_lake, 0)) FILTER (WHERE uwb.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[]) +
          SUM(COALESCE(uwb.area_manmade, 0)) FILTER (WHERE uwb.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[])) / 10000)::numeric, 2) AS ch_cm_co_pk_sk_lakereservoir_ha,
  ROUND(((SUM(COALESCE(uwb.area_wetland, 0)) FILTER (WHERE uwb.barriers_ch_cm_co_pk_sk_dnstr = array[]::text[])) / 10000)::numeric, 2) AS ch_cm_co_pk_sk_wetland_ha,

  ROUND(((SUM(COALESCE(uwb.area_lake, 0)) FILTER (WHERE uwb.barriers_st_dnstr = array[]::text[]) +
          SUM(COALESCE(uwb.area_manmade, 0)) FILTER (WHERE uwb.barriers_st_dnstr = array[]::text[])) / 10000)::numeric, 2) AS st_lakereservoir_ha,
  ROUND(((SUM(COALESCE(uwb.area_wetland, 0)) FILTER (WHERE uwb.barriers_st_dnstr = array[]::text[])) / 10000)::numeric, 2) AS st_wetland_ha,
  ROUND(((SUM(COALESCE(uwb.area_lake, 0)) FILTER (WHERE uwb.barriers_wct_dnstr = array[]::text[]) +
          SUM(COALESCE(uwb.area_manmade,0)) FILTER (WHERE uwb.barriers_wct_dnstr = array[]::text[])) / 10000)::numeric, 2) AS wct_lakereservoir_ha,
  ROUND(((SUM(COALESCE(uwb.area_wetland, 0)) FILTER (WHERE uwb.barriers_wct_dnstr = array[]::text[])) / 10000)::numeric, 2) AS wct_wetland_ha,
...
SET
  ...
  ch_cm_co_pk_sk_lakereservoir_ha = r.ch_cm_co_pk_sk_lakereservoir_ha,
  ch_cm_co_pk_sk_wetland_ha = r.ch_cm_co_pk_sk_wetland_ha,
...
(SELECT
  ...
  ROUND((COALESCE(a.ch_cm_co_pk_sk_network_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_network_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_network_km,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_stream_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_stream_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_stream_km,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_lakereservoir_ha, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_lakereservoir_ha, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_lakereservoir_ha,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_wetland_ha, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_wetland_ha, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_wetland_ha,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_slopeclass03_waterbodies_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_slopeclass03_waterbodies_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_slopeclass03_waterbodies_km,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_slopeclass03_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_slopeclass03_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_slopeclass03_km,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_slopeclass05_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_slopeclass05_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_slopeclass05_km,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_slopeclass08_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_slopeclass08_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_slopeclass08_km,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_slopeclass15_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_slopeclass15_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_slopeclass15_km,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_slopeclass22_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_slopeclass22_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_slopeclass22_km,
  ROUND((COALESCE(a.ch_cm_co_pk_sk_slopeclass30_km, 0) - SUM(COALESCE(b.ch_cm_co_pk_sk_slopeclass30_km, 0)))::numeric, 2) ch_cm_co_pk_sk_belowupstrbarriers_slopeclass30_km,
...
SET
  ...
  ch_cm_co_pk_sk_belowupstrbarriers_network_km = r.ch_cm_co_pk_sk_belowupstrbarriers_network_km,
  ch_cm_co_pk_sk_belowupstrbarriers_stream_km = r.ch_cm_co_pk_sk_belowupstrbarriers_stream_km,
  ch_cm_co_pk_sk_belowupstrbarriers_lakereservoir_ha = r.ch_cm_co_pk_sk_belowupstrbarriers_lakereservoir_ha,
  ch_cm_co_pk_sk_belowupstrbarriers_wetland_ha = r.ch_cm_co_pk_sk_belowupstrbarriers_wetland_ha,
  ch_cm_co_pk_sk_belowupstrbarriers_slopeclass03_waterbodies_km = r.ch_cm_co_pk_sk_belowupstrbarriers_slopeclass03_waterbodies_km,
  ch_cm_co_pk_sk_belowupstrbarriers_slopeclass03_km = r.ch_cm_co_pk_sk_belowupstrbarriers_slopeclass03_km,
  ch_cm_co_pk_sk_belowupstrbarriers_slopeclass05_km = r.ch_cm_co_pk_sk_belowupstrbarriers_slopeclass05_km,
  ch_cm_co_pk_sk_belowupstrbarriers_slopeclass08_km = r.ch_cm_co_pk_sk_belowupstrbarriers_slopeclass08_km,
  ch_cm_co_pk_sk_belowupstrbarriers_slopeclass15_km = r.ch_cm_co_pk_sk_belowupstrbarriers_slopeclass15_km,
  ch_cm_co_pk_sk_belowupstrbarriers_slopeclass22_km = r.ch_cm_co_pk_sk_belowupstrbarriers_slopeclass22_km,
  ch_cm_co_pk_sk_belowupstrbarriers_slopeclass30_km = r.ch_cm_co_pk_sk_belowupstrbarriers_slopeclass30_km,
