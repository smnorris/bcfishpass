...
select distinct on (s.assessment_watershed_id)
  ...
  -- percentages
  round(coalesce((s.length_naturallyaccessible_obsrvd_bt_access_b + s.length_naturallyaccessible_model_bt_access_b) / nullif((s.length_naturallyaccessible_obsrvd_bt + s.length_naturallyaccessible_model_bt), 0), 0) * 100, 2) as pct_naturallyaccessible_bt_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_ch_access_b + s.length_naturallyaccessible_model_ch_access_b) / nullif((s.length_naturallyaccessible_obsrvd_ch + s.length_naturallyaccessible_model_ch), 0), 0) * 100, 2) as pct_naturallyaccessible_ch_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_cm_access_b + s.length_naturallyaccessible_model_cm_access_b) / nullif((s.length_naturallyaccessible_obsrvd_cm + s.length_naturallyaccessible_model_cm), 0), 0) * 100, 2) as pct_naturallyaccessible_cm_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_co_access_b + s.length_naturallyaccessible_model_co_access_b) / nullif((s.length_naturallyaccessible_obsrvd_co + s.length_naturallyaccessible_model_co), 0), 0) * 100, 2) as pct_naturallyaccessible_co_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_pk_access_b + s.length_naturallyaccessible_model_pk_access_b) / nullif((s.length_naturallyaccessible_obsrvd_pk + s.length_naturallyaccessible_model_pk), 0), 0) * 100, 2) as pct_naturallyaccessible_pk_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_sk_access_b + s.length_naturallyaccessible_model_sk_access_b) / nullif((s.length_naturallyaccessible_obsrvd_sk + s.length_naturallyaccessible_model_sk), 0), 0) * 100, 2) as pct_naturallyaccessible_sk_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_salmon_access_b + s.length_naturallyaccessible_model_salmon_access_b) / nullif((s.length_naturallyaccessible_obsrvd_salmon + s.length_naturallyaccessible_model_salmon), 0), 0) * 100, 2) as pct_naturallyaccessible_salmon_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_st_access_b + s.length_naturallyaccessible_model_st_access_b) / nullif((s.length_naturallyaccessible_obsrvd_st + s.length_naturallyaccessible_model_st), 0), 0) * 100, 2) as pct_naturallyaccessible_st_access_b,
  round(coalesce((s.length_naturallyaccessible_obsrvd_wct_access_b + s.length_naturallyaccessible_model_wct_access_b) / nullif((s.length_naturallyaccessible_obsrvd_wct + s.length_naturallyaccessible_model_wct), 0), 0) * 100, 2) as pct_naturallyaccessible_wct_access_b,
