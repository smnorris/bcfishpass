...
With over 500,000 mapped locations of road/rail stream crossings representing potential barriers across BC, field assessment for all sites is not feasible and a system for site prioritization is essential. Developed by Hillcrest Geographics for the FPTWG, the Canadian Wildlife Foundation (CWF), the Pacific Salmon Foundation (PSF), and others `bcfishpass` provides users a common reference point by modelling and/or tracking:
