...
drop materialized view if exists bcfishpass.map_cm_vw;

create materialized view bcfishpass.map_cm_vw as
...
select 
  ...
  case 
    ...
    when 
      ...
      model_spawning_cm is null
    then 'ACCESS' 
    -- potential spawning
    when model_spawning_cm is not null
    then 'SPAWN'
