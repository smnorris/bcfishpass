delete from bcfishpass.barriers_pk
...
(
  ...
  union all
  select
      barriers_gradient_12_id as barrier_id,
      barrier_type,
      barrier_name,
      linear_feature_id,
      blue_line_key,
      ...
      watershed_group_code,
      geom
  from bcfishpass.barriers_gradient_12
  where watershed_group_code = :'wsg'
  union all
  select
...
(
  ...
  where o.species_codes && array['PK']
),
...
insert into bcfishpass.barriers_pk
(
    barriers_pk_id,
    barrier_type,
    barrier_name,
