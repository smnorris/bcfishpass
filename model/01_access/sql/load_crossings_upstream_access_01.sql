...
(
  ...
  FROM bcfishpass.crossings a
  left outer join bcfishpass.streams s
  ON a.blue_line_key = s.blue_line_key  -- use blkey in case crossing match to stream feature is inconsistent
  ...
  ON a.blue_line_key = s2.blue_line_key -- use blkey in case crossing match to stream feature is inconsistent
