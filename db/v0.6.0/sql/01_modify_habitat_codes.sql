...
select
  s.segmented_stream_id,
  case
    when u.spawning_bt is false then -1
  ...
  case
    when u.spawning_ch is false then -1
  ...
  case
    when u.spawning_cm is false then -1
  ...
  case
    when u.spawning_co is false then -1
  ...
  case
    when u.spawning_pk is false then -1
  ...
  case
    when u.spawning_sk is false then -1
  ...
  case
    when u.spawning_st is false then -1
  ...
  case
    when u.spawning_wct is false then -1
  ...
  case
    when u.rearing_bt is false then -1
  ...
  case
    when u.rearing_ch is false then -1
  ...
  case
    when u.rearing_co is false then -1
  ...
  case
    when u.rearing_sk is false then -1
  ...
  case
    when u.rearing_st is false then -1
  ...
  case
    when u.rearing_wct is false then -1
