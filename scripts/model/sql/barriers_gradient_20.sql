DELETE FROM bcfishpass.barriers_gradient_20;
...
-- note inclusion of 25% - source table creates breaks at 5% intervals but this table must include
-- all gradient barriers between 20 and 30%
WHERE b.gradient_class IN (20, 25)
