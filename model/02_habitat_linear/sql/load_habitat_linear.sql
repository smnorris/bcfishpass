...
begin;
  ...
  select
    ...
    case
      when coalesce(bt.spawning, false) is false and coalesce(u.spawning_bt, 0) = -4 then -4
      when coalesce(bt.spawning, false) is true and coalesce(u.spawning_bt, 0) = -4 then -4
    ...
    case
      when coalesce(ch.spawning, false) is false and coalesce(u.spawning_ch, 0) = -4 then -4
      when coalesce(ch.spawning, false) is true and coalesce(u.spawning_ch, 0) = -4 then -5
    ...
    case
      when coalesce(cm.spawning, false) is false and coalesce(u.spawning_cm, 0) = -4 then -4
      when coalesce(cm.spawning, false) is true and coalesce(u.spawning_cm, 0) = -4 then -5
    ...
    case
      when coalesce(co.spawning, false) is false and coalesce(u.spawning_co, 0) = -4 then -4
      when coalesce(co.spawning, false) is true and coalesce(u.spawning_co, 0) = -4 then -5
    ...
    case
      when coalesce(pk.spawning, false) is false and coalesce(u.spawning_pk, 0) = -4 then -4
      when coalesce(pk.spawning, false) is true and coalesce(u.spawning_pk, 0) = -4 then -5
    ...
    case
      when coalesce(sk.spawning, false) is false and coalesce(u.spawning_sk, 0) = -4 then -4
      when coalesce(sk.spawning, false) is true and coalesce(u.spawning_sk, 0) = -4 then -5
    ...
    case
      when coalesce(st.spawning, false) is false and coalesce(u.spawning_st, 0) = -4 then -4
      when coalesce(st.spawning, false) is true and coalesce(u.spawning_st, 0) = -4 then -5
    ...
    case
      when coalesce(wct.spawning, false) is false and coalesce(u.spawning_wct, 0) = -4 then -4
      when coalesce(wct.spawning, false) is true and coalesce(u.spawning_wct, 0) = -4 then -5
    ...
    case
      when coalesce(bt.rearing, false) is false and coalesce(u.rearing_bt, 0) = -4 then -4
      when coalesce(bt.rearing, false) is true and coalesce(u.rearing_bt, 0) = -4 then -5
    ...
    case
      when coalesce(ch.rearing, false) is false and coalesce(u.rearing_ch, 0) = -4 then -4
      when coalesce(ch.rearing, false) is true and coalesce(u.rearing_ch, 0) = -4 then -5
    ...
    case
      when coalesce(co.rearing, false) is false and coalesce(u.rearing_co, 0) = -4 then -4
      when coalesce(co.rearing, false) is true and coalesce(u.rearing_co, 0) = -4 then -5
    ...
    case
      when coalesce(sk.rearing, false) is false and coalesce(u.rearing_sk, 0) = -4 then -4
      when coalesce(sk.rearing, false) is true and coalesce(u.rearing_sk, 0) = -4 then -5
    ...
    case
      when coalesce(st.rearing, false) is false and coalesce(u.rearing_st, 0) = -4 then -4
      when coalesce(st.rearing, false) is true and coalesce(u.rearing_st, 0) = -4 then -5
    ...
    case
      when coalesce(wct.rearing, false) is false and coalesce(u.rearing_wct, 0) = -4 then -4
      when coalesce(wct.rearing, false) is true and coalesce(u.rearing_wct, 0) = -4 then -5
